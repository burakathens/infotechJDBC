...
public class DatabaseConnectorV1{
    ...
    private static final String dbusername = ConfigReader.getProperty("databaseUsernamePostgre");
    private static final String dbpassword = ConfigReader.getProperty("databasePasswordPostgre");
    private static final String connectionUrl = ConfigReader.getProperty("databaseURLPostgre");
